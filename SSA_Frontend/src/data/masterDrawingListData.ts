...
export const PROJECT_17_FOLDERS: DisciplineMeta[] = [
  ...
  },
  {
    ...
    subfolders: [
      ...
      'Geotechnical & Soil Test Reports',
      'Boundary Demarcation & Coordinates',
      'Site Photos & Drone Footage',
      'Existing Utilities & Surroundings',
    ],
  },
  {
    folderNumber: 3,
  ...
  },
  {
    ...
    sequenceOrder: 6,
    code: 'MEP',
    name: 'MEP & OTHER SERVICE DRAWINGS',
    category: 'Design & Engineering',
  ...
  },
  {
    ...
    subfolders: [
      'Package-wise BOQs (Civil, MEP, Interior)',
      'Cost Estimates & Budgets',
      'Rate Analysis & Market Quotations',
      'Material Quantity Takeoffs (MTO)',
  ...
  },
  {
    ...
    subfolders: [
      ...
      'Technical Specifications & Makes',
      'Tender Addenda & Pre-bid Clarifications',
      'Bid Submissions & Comparative Statements',
      'Letter of Intent (LOI) & Work Orders',
    ],
  },
  {
    folderNumber: 9,
    ...
    subfolders: [
      ...
      'QA & QC Inspection Reports & Pour Cards',
      'Site Progress Photographs & Videos',
      'Safety & HSE Incident Logs',
    ],
  },
  {
    folderNumber: 10,
    ...
    subfolders: [
      ...
      'Manufacturer Test Certificates & Catalogs',
      'Sample Submissions & Physical Approvals',
      'Contractor Shop Drawings',
      'Mock-up Inspections & Sign-offs',
    ],
  },
  {
    folderNumber: 11,
    ...
    subfolders: [
      ...
      'Consultant Clarifications & Sketches',
      'Site Instructions (SI)',
      'Technical Deviation Reports',
    ],
  },
  {
    folderNumber: 12,
    ...
    subfolders: [
      'Client Coordination Meetings (MOM)',
      'Consultant Review Meetings (MOM)',
      'Contractor Progress Review Meetings (MOM)',
      'Letters to Client',
      'Letters to Contractors & Notices',
  ...
  },
  {
    ...
    subfolders: [
      'Master Baseline Schedule (Primavera / MSP)',
      'Monthly Target Schedules',
      '3-Week / Look-Ahead Schedules',
      'Critical Path & Delay Analysis (EOT)',
      'Milestone Trackers',
    ],
  },
  {
    ...
    subfolders: [
      'Contractor RA Bills & Measurements',
      'Payment Recommendation Certificates (IPC)',
      'Variation Orders & Extra Items (VO)',
      'Price Escalation & Secured Advances',
      'Cash Flow Forecasts & Spend Curves',
    ],
  },
  {
    folderNumber: 15,
    ...
    subfolders: [
      'Planning Permission & Building Sanction',
      'Fire Department NOC (Provisional & Final)',
      'Environmental Clearance (PCB / SEIAA)',
      'Utility Approvals (Power / Water / Sewerage)',
      'Airport Authority & Heritage NOCs',
      'Completion & Occupancy Certificate (CC/OC)',
    ],
  },
  {
    folderNumber: 16,
    ...
    subfolders: [
      'Testing & Commissioning Plan & Method Statements',
      'Hydrostatic & Pressure Test Certificates',
      'MEP Equipment Performance Logs',
      'Integrated System Testing (IST) Reports',
      'Pre-handover Snag Lists & De-snagging',
    ],
  },
  {
    folderNumber: 17,
    ...
    subfolders: [
      'Final As-Built Drawings (Civil & MEP)',
      'Operation & Maintenance (O&M) Manuals',
      'Equipment Warranties & Guarantees',
      'Asset Register & Spares Handover',
      'Key Handover & Area Takeover Protocol',
      'Final Completion & Release Certificates',
    ],
  },
